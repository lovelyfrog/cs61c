...
mapLoop:
    lw t1, 0(s0)      # load the address of the array of current node into t1 ---Error 2
    lw t2, 4(s0)        # load the size of the node's array into t2

    slli t0, t0, 2
    add t1, t1, t0      # offset the array address by the count ---Error 1
    srli t0, t0, 2
    ...
    lw a0, 8(s0)        # load the address of the next node into a0 ---Error 3
